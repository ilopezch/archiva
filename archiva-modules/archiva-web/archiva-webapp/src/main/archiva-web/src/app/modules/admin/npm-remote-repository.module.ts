...
import {NpmRemoteRepositoryRoutingModule} from './npm-remote-repository-routing.module';
...
@NgModule({
    declarations: [
        ManageNpmRemoteRepoComponent,
        ManageNpmRemoteRepoListComponent,
        ManageNpmRemoteRepoAddComponent,
        ManageNpmRemoteRepoEditComponent
    ],
    imports: [
        CommonModule,
        SharedModule,
        NpmRemoteRepositoryRoutingModule,
        FormsModule,
        ReactiveFormsModule
    ]
})
export class NpmRemoteRepositoryModule {
}
