...
import {RpmRepositoryRoutingModule} from './rpm-repository-routing.module';
...
@NgModule({
    declarations: [
        ManageRpmRepoComponent,
        ManageRpmRepoListComponent,
        ManageRpmRepoAddComponent,
        ManageRpmRepoEditComponent
    ],
    imports: [
        CommonModule,
        SharedModule,
        RpmRepositoryRoutingModule,
        FormsModule,
        ReactiveFormsModule
    ]
})
export class RpmRepositoryModule {
}
