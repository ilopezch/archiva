...
import org.apache.archiva.rest.api.v2.model.RpmRemoteRepository;
...
import org.apache.archiva.rest.api.v2.svc.rpm.RpmRemoteRepositoryService;
...
/**
 * Default implementation of {@link RpmRemoteRepositoryService}.
 */
@Service( "v2.remoteRpmRepositoryService#rest" )
public class DefaultRpmRemoteRepositoryService extends AbstractService implements RpmRemoteRepositoryService
{
    private static final Logger log = LoggerFactory.getLogger( DefaultRpmRemoteRepositoryService.class );
    ...
    public DefaultRpmRemoteRepositoryService( RepositoryRegistry repositoryRegistry,
    ...
    @Override
    public PagedResult<RpmRemoteRepository> getRemoteRepositories( String searchTerm, Integer offset,
        ...
        try
        {
            ...
            return PagedResult.of( totalCount, offset, limit,
                repos.stream().filter( queryFilter ).sorted( comparator )
                    .map( RpmRemoteRepository::of ).skip( offset ).limit( limit )
    ...
    @Override
    public RpmRemoteRepository getRemoteRepository( String repositoryId )
        throws ArchivaRestServiceException
    {
        ...
        return RpmRemoteRepository.of( repo );
    }

    @Override
    public RpmRemoteRepository addRemoteRepository( RpmRemoteRepository remoteRepository )
        throws ArchivaRestServiceException
    {
        ...
        try
        {
            ...
            return RpmRemoteRepository.of( repositoryRegistry.getRemoteRepository( repoId ) );
        }
        catch ( RepositoryException e )
        {
            log.error( "Could not create RPM remote repository {}: {}", repoId, e.getMessage(), e );
            throw new ArchivaRestServiceException( ErrorMessage.of( ErrorKeys.REPOSITORY_ADD_FAILED, repoId ) );
        }
    }

    @Override
    public RpmRemoteRepository updateRemoteRepository( String repositoryId, RpmRemoteRepository remoteRepository )
        throws ArchivaRestServiceException
    {
        ...
        try
        {
            ...
            return RpmRemoteRepository.of( updated );
        }
    ...
    private RemoteRepositoryConfiguration toConfig( RpmRemoteRepository dto )
    {
    ...
    private org.apache.archiva.admin.model.beans.RemoteRepository toAdminBean( RpmRemoteRepository dto )
    {
