...
/**
 * Groups one or more RPM managed repositories under a single virtual yum endpoint.
 */
public class RpmRepositoryGroup extends AbstractRepositoryGroup
{
    ...
    public RpmRepositoryGroup( String id, String name, FilesystemStorage storage )
    {
