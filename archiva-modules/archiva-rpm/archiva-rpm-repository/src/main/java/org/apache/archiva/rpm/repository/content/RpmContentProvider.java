...
/**
 * Creates RPM-specific repository content instances.
 */
@Service( "repositoryContentProvider#rpm" )
public class RpmContentProvider implements RepositoryContentProvider
{
    private static final Set<RepositoryType> SUPPORTED_TYPES = Collections.singleton( RepositoryType.RPM );

    @Override
    public boolean supportsLayout( String layout )
    {
        return "rpm-default".equals( layout );
    }
    ...
    {
        return RepositoryType.RPM.equals( type );
    }
    ...
    public ManagedRepositoryContent createManagedContent( ManagedRepository repository ) throws RepositoryException
    {
        ...
        return new RpmManagedRepositoryContent( repository );
    }
