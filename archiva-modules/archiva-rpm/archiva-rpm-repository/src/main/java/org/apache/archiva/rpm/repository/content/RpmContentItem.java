...
/**
 * Minimal content item representing a single file or directory in an RPM repository.
 */
public class RpmContentItem implements ContentItem
{
    ...
    public RpmContentItem( StorageAsset asset, ManagedRepositoryContent content )
    {
        this.asset = asset;
